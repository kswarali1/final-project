...
```{r}
filter(total_data, AcceptanceRate < 20 & world_rank < 100)
```
Within this section of the code, we decided to filter the universities that had an acceptance rate of less than 20% and were within the top 100 ranked schools. 
